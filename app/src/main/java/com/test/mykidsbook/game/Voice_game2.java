...
public class Voice_game2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voice_game2);
        ...
        lottieAnimationView=findViewById(R.id.animationView_game2);
        ...
        qus_no=findViewById(R.id.qus_no_id_game2);
        score=findViewById(R.id.score_id_game2);
        qus=findViewById(R.id.qus_id_game2);
        next=findViewById(R.id.next_qus_id_game2);
        button1=findViewById(R.id.button1_id_game2);
        button2=findViewById(R.id.button2_id_game2);
    ...
    private void next_level_dialog(){
        ...
        imageViewclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent it=new Intent(Voice_game2.this, Game_Home.class);
                startActivity(it);
            }
        });
        buttonOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it=new Intent(Voice_game2.this, Voice_game3.class);
                startActivity(it);
            }
        });
        dialog.show();
